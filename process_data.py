...
def main(args):
    ...
    savemat('data/spike/spike_indy_20160630_01.mat', matlab_vars)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_filepath',   type=str,   default=f"data/spike/indy_20160630_01.mat",   help='Path to the raw data')
    parser.add_argument('--output_filepath',  type=str,    default=f"data/spike/indy_20160630_01.h5",  help='Path to the spike and kinematic data')
