...
def main(args):
    ...
    def objective(trial):
        ...
        config = {"input_dim": X.shape[-1],
                  ...
                  "timesteps": trial.suggest_int("timesteps", 1, 10),
                  "n_layers": trial.suggest_int("n_layers", 1, 3),
                  "units": trial.suggest_int("units", 50, 200, step=75),
                  "window_size": 2,
                  "batch_size": trial.suggest_categorical("batch_size", [32, 64, 96, 128]),
                  "epochs": trial.suggest_categorical("epochs", 1, 100),
...
if __name__ == '__main__':
    ...
    parser.add_argument('--feature',          type=str,   default='mua',  help='Type of spiking activity')
    ...
    parser.add_argument('--min_train_size',   type=float, default=0.8,    help='Minimum (fraction) of training data size')
